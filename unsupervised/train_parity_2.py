...
def main():
    ...
    parser.add_argument('--target_loss', type=float, default=0.005, help='Target loss to stop each phase')
    ...
    parser.add_argument('--seed', type=int, default=8, help='Random seed') #54
